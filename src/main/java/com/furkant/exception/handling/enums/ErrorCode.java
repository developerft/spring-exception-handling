package com.furkant.exception.handling.enums;
...
public enum ErrorCode {
    ...
    BIND_EXCEPTION("0002", "BindException"), TYPE_MISMATCH_EXCEPTION("0003", "TypeMismatchException"),
    ...
    USER_ALREADY_SAVED_EXCEPTION("0021", "User already saved");

    private static final String ERROR_PREFIX = "EX-";
